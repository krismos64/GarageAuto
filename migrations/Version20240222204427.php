 ...
 */
final class Version20240222204427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reviews ADD customer_id INT DEFAULT NULL, ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reviews DROP customer_id, DROP user_id');
    }
}
